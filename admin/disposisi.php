...
<body>
	...
	<div class="panel panel-headline demo-icons">
		...
		<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Disposisi</button>
		<br/>
		<br/>
		<br/>
			...
			<div class="modal-body">
				<form action="tmb_disposisi.php" method="post">
					...
					<div class="form-group">
						...
						<input name="tanggal" type="date" class="form-control" placeholder="Tanggal Disposisi ..">
					</div>	
					<div class="form-group">
						<label>Disposisi Ke</label>
						<input name="disposisi_ke" type="text" class="form-control" placeholder="Disposisi ke ..">
					</div>
					<div class="form-group">
